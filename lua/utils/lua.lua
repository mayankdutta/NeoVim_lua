...
-- o: for setting global options
-- b: for setting buffer-scoped options
-- w: for setting window-scoped options
...
-- to choose b/w o, b, w: type ':h' and then 'tag name' check if there is
-- local to buffer
-- or global.
-- or window
